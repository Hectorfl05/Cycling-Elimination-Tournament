...
private: System::Void Start_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//Foreach que recorre el vector Ciclista, y segun la prueba asignada a cada ciclista, lo añade al vector correspondiente
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	// Si los participantes designados para la prueba son mayores que 4, ejecuta la prueba
	...
	//Instancia de la Struct Perdedores
	Perdedores  newperdedor;

	//Reinicia los Datagridview que contienen los participantes, finalistas y eliminados
	...
	Eliminados->Rows->Clear();
		...
		//Si los ciclistas asignados a la prueba son mayores que 4, se comienza a eliminar los ciclistas que ocupan la posicion 5 hasta el final del vector
		if(ciclistasConMinCont.size() > 4)
		{
		...
		//Foreach que recorre el vector ciclistasConMinCont, realizando conversiones para mostrar los datos en un datagridview, de los participantes de la prueba
		...
		//Foreach que recorre el vector ciclistaConMinCont, realizando conversiones para mostrar los datos en un datagridview de los Finalistas
		...
		//Foreach que recorre el vector Perdedores, realizando conversiones para mostrar los datos en un datagridview de los eliminados
		...
		//Limpia el datagridview que contiene a los competidores

		TablaJugadores->Rows->Clear();

		//Vuelve a llenar el datagridview de competidores para actualizar la Tabla de Jugadores
		...
		//Libera los espacios que ocupan ambos vectores
		Competidores.clear();
	...
	}else
	{
		...
		//foreach que recorre el vector Ciclista, y adjusta el valor maximo de puntos
		...
		//foreach que recorre el vector Ciclista, identificando el elemento que tenga el mayor puntaje, y se muestra como ganador de la competicion
			for (Ciclista ganador : *ciclistas)
			{
